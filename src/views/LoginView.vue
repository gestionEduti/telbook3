...
<template>
  <div class="flex min-h-screen flex-col">
    ...
    <div class="mt-auto">
      <Separator class="mb-4" decorative />
      <footer class="flex items-center justify-end px-8 py-6 bg-gray-50/50 text-sm text-gray-500">
        <div class="flex items-center gap-2">
          <span class="text-gray-600">Sistema creado por</span>
          <a
            href="https://eduti.cl"
            target="_blank"
