...
// icons
import { Map, User, Users } from 'lucide-vue-next'
...
<template>
  <div class="grid grid-cols-3 gap-4" v-if="alumno">
    <!-- datos personales -->
    <Card>
      <CardHeader>
      ...
      <CardContent>
        ...
        <div v-if="alumno.sexo_alumno" class="text-sm font-semibold tracking-tighter text-gray-400">
          Sexo
        </div>
